...
export default function OnePiecePage() {
  ...
  /* ================= FILTER ================= */
  const filteredProducts = onePieceProducts
    .filter((p) =>
        ...
        <div className="dashboard-layout">
          ...
          <aside className="sidebar">
            ...
            <ul>
              ...
              <li className="active"><Link href="/dashboard/category/onepiece">1 Piece Set</Link></li>
            </ul>
          ...
          {/* ================= MAIN ================= */}
          <main>
            <h2 className="pickTitle">1 Piece Set</h2>
...
>
  <img src={p.image} alt={p.title} />
                  ...
                  <div className={styles.categoryInfo}>
                    <div className={styles.categoryTag}>ONE PIECE</div>
