...
import "../../dashboard.css"; // layout only
...
export default function CasualPage() {
  ...
  const filteredProducts = casualProducts
    ...
    .filter((p) => {
      if (p.price > priceRange) return false; // 🆕 slider logic
        ...
        <div className="dashboard-layout">
          ...
          <aside className="sidebar">
            ...
            <ul>
              ...
              <li className="active"><Link href="/dashboard/category/casual">Casual Wear</Link></li>
              ...
              <li><Link href="/dashboard/category/onepiece">1Piece Set</Link></li>
            </ul>

            {/* ===== OLD PRICE INPUTS (KEPT AS-IS) ===== */}
