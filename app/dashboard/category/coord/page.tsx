...
export default function CoordPage() {
  ...
  /* ================= FILTER ================= */
  const filteredProducts = coordProducts
    .filter((p) =>
        ...
        <div className="dashboard-layout">
          ...
          <aside className="sidebar">
            ...
            <ul>
              ...
              <li className="active"><Link href="/dashboard/category/coord">Co-ord Set</Link></li>
          ...
          {/* ================= MAIN ================= */}
          <main>
            <h2 className="pickTitle">Co-ord Set</h2>
              ...
              {filteredProducts.map((p) => (
                <div key={p.id} className={styles.categoryCard}>
                  ...
                  <div className={styles.categoryInfo}>
                    <div className={styles.categoryTag}>CO-ORD</div>
